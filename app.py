...
# ==========================================
# 1. Geokodiranje i način pretraživanja
# ==========================================
def get_coordinates(location_name):
    """ Pretvori unesenu lokaciju u geografske koordinate pomoću OpenStreetMap (Nominatim) """
    try:
...
if mode == "今すぐ探す（現在地GPS）":
    ...
    # Pretvori uneseno ime lokacije u točne koordinate
    if target_location:
        lat, lon, _ = get_coordinates(target_location)

# ==========================================
# 2. Vremenska prognoza u realnom vremenu
# ==========================================
is_rain = False
...
# ==========================================
# 4. Popis kafića (stvarne adrese, kompaktniji dizajn)
# ==========================================
st.header("🏪 カフェ穴場判定 ＆ 立ち回りナビ")

# Kompaktan popis sa stvarnijim profilima lokacija
cafes = [
    {
...
for cafe in cafes:
    ...
    # Kompaktniji prikaz sa stisnutim redovima
...
# ==========================================
# 5. Karta prilagođena točnoj lokaciji
# ==========================================
st.header("🗺️ 周辺マップ")
